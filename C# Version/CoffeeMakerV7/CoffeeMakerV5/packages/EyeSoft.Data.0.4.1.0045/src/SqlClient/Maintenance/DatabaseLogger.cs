namespace EyeSoft.Data.SqlClient.Maintenance
{
	...
	public class DatabaseLogger
	{
		...
		public void Failed(string databaseName, Exception exception)
		{
			...
			Append("Database failed {0}, at time: {1}. {2}", databaseName, FullTime(), exception.FullMessage());
		}
		...
		public void Failed(Exception exception)
		{
			...
			Append("Error before start {0}, message: {1}", operationName, exception.FullMessage());
		}
