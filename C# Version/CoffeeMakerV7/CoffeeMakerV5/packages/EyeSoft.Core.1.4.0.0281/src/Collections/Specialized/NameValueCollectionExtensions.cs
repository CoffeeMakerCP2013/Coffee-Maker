namespace EyeSoft.Collections.Specialized
{
	...
	{
		public static T Read<T>(this NameValueCollection collection, string key)
		{
		...
		public static T ReadOrDefault<T>(this NameValueCollection collection, string key, T defaultValue = default(T))
		{
			var value = collection[key];
