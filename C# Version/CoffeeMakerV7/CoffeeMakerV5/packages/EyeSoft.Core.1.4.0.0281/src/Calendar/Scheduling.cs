namespace EyeSoft.Calendar
{
	...
	public static class Scheduling
	{
		...
		public static IEnumerable<DateTime> RecurrencyDays(RecurrencyFrequency frequency, DateTime start, DateTime end, DateTime eventDate)
		{
			var startRecurrencyDate = StartRecurrencyDate(frequency, start, eventDate);
